(window.webpackJsonp=window.webpackJsonp||[]).push([[17],{"+Cau":function(e,t,n){"use strict"
var a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.receiverMap=t.createMessageBucket=void 0
var r=a(n("MVZn")),l=a(n("zkrS")),s=n("upRB")
t.createMessageBucket=function(i){function o(e,t,n){var a=1<arguments.length&&void 0!==t?t:{},r=2<arguments.length&&void 0!==n?n:"*"
return e&&window.parent.postMessage(JSON.stringify({event:e,payload:a}),r)}function e(t){if(t.source!==window&&!t.origin.includes("qiyukf")&&t.data&&"string"==typeof t.data)try{var e=JSON.parse(t.data),n=e.event,a=e.payload,r=void 0===a?{}:a
i[n]&&i[n](o,{type:n,payload:r,event:t})}catch(e){console.warn("[receive] error message data",e,t)}}return window.addEventListener("message",e),{send:o,clear:function(){return window.removeEventListener("message",e)}}}
...
return isNaN(t)?e:t}function a(r){return function(e,t){void 0===t&&(t="16px")
var n=e,a=t
...
return""+n/a+r}}var s=a("em"),c=/^([+-]?(?:\d+|\d*\.\d+))([a-z]*|%)$/
...
return{backgroundColor:a||function(e){return e[0].split(" ")[0]}(t),backgroundImage:function(e,t,n,a){for(var r="",i=0;i<e.length;i+=1)r+=e[i],3===i&&(i+1<1||arguments.length<=i+1?void 0:arguments[i+1])&&((arguments.length<=1?void 0:t)||(arguments.length<=2?void 0:n)||(arguments.length<=3?void 0:a))?(r=r.slice(0,-1),r+=", "+(i+1<1||arguments.length<=i+1?void 0:arguments[i+1])):3!==i||i+1<1||arguments.length<=i+1||!arguments[i+1]||(arguments.length<=1?void 0:t)||(arguments.length<=2?void 0:n)||(
arguments.length<=3?void 0:a)?(i+1<1||arguments.length<=i+1?void 0:arguments[i+1])&&(r+=(i+1<1||arguments.length<=i+1?void 0:arguments[i+1])+" "):r+=""+(i+1<1||arguments.length<=i+1?void 0:arguments[i+1])
return r.trim()}(M(),r,i,n,t.join(", "))}}function I(e,t,n,a,r){var i
...
"1qiG":function(e,t,n){"use strict"
...
S.f.inSharing=!0
function w(){return window.MBData}S.load=function(){var t=(0,r.default)(m.default.mark(function e(n){var a,r,i,o,l,s,c,u,d,f,p,h
...
t.createWorkspacePusher=function(e){function b(e){var t=0<arguments.length&&void 0!==e?e:[],o=h(),n=t.reduce(function(e,t){var n=t.object,a=n.cid,r=n.mtime,i=void 0===r?o:r
return e[a]=i,e},{})
return a(n)}var t,n,a=e.filterStaleData,r=(0,y.default)({},k.initialSocketState,{userId:C.user.id,projectCidList:[]}),i={"broadcast:user:data":function(e){e.type
...
function m(){return window.MB_DESKTOP_SNAPSHOT||window.parent.MB_DESKTOP_SNAPSHOT}function r(e){return"function"==typeof m()&&e.projectAccessToken&&g.default.SpineModel.Project.findAllByAttribute("access_token",e.projectAccessToken)}var f=a(n("MVZn")),p=a(n("J4zp")),v=a(n("o0o1")),i=a(n("yXPU")),g=a(n("zkrS")),o=n("r2i6"),y=n("/N2d"),h=n("CpT9"),l=window.location,b="".concat(l.origin,"/api/v2/snapshots/public")
t.isPublicProjectAvailable=r
t.isPublicScreenAvailable=function(e){return r(e)&&e.screenCid&&g.default.SpineModel.Screen.find(e.screenCid)}
var S=(0,o.createCacheMap)({valueSizeSumMax:8388608,valueSizeSingleMax:1048576}),s=function(){var t=(0,i.default)(v.default.mark(function e(t){var n,a,r,i,o,l,s,c,u,d,f,p,h
return v.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(n=t.imageElement,t.projectAccessToken,a=t.screenCid,r=t.screenStateCid,i=void 0===r?"default":r,o=t.mode,void 0===o?"thumbnail":o,l=t.version,s=void 0===l?"":l,e.prev=1,u=g.default.SpineModel.Screen.find(a),d=128/Math.max(u.width,u.height),f="".concat(a,"|").concat(i,"|").concat(d),void 0===(c=S.get("".concat(f,"|").concat(s))))return e.next=9,m()({snapshotMode:"png-base64",snapshotUrl:b,taskList:[(0,y.doRenderScreenToHTMLString)({
...
var c=function(){var t=(0,i.default)(v.default.mark(function e(t){var n,a,r,i,o,l
return v.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return t.projectAccessToken,n=t.screenCid,a=t.canvasZoom,r=void 0===a?1:a,i=g.default.SpineModel.Screen.find(n),e.next=5,m()({snapshotMode:"png-file",snapshotUrl:b,snapshotOutputFile:"".concat((0,h.getScreenFileName)(i),".png"),taskList:[(0,y.doRenderScreenToHTMLString)({screenCid:n,screenStateCid:"default",canvasZoom:r})]})
...
var u=function(){var t=(0,i.default)(v.default.mark(function e(t){var n,a,r,i,o,l,s,c,u,d
return v.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=t.projectAccessToken,a=t.canvasZoom,r=void 0===a?1:a,i=t.onProgress,o=g.default.SpineModel.Project.findAllByAttribute("access_token",n),l=(0,p.default)(o,1),s=l[0],c=g.default.SpineModel.Screen.findAllByAttribute("project_cid",s.cid),e.next=5,m()({snapshotMode:"png-zip-file",snapshotUrl:b,snapshotOutputFile:"".concat(s.name,".zip"),taskList:c.map(function(e){return(0,f.default)({},(0,y.doRenderScreenToHTMLString)({
...
32!==e.keyCode||n||(e.preventDefault(),t({type:"preview:set:key:flags",payload:{isSpaceDown:!0}}))}),(0,d.default)((0,c.default)(a),"handleKeyUp",function(e){a.props.dispatch({type:"preview:reset:key:flags"})}),(0,d.default)((0,c.default)(a),"handleMouseDown",function(e){var t=a.props.isSpaceDown
1!==e.button&&!t||a.initDraggingCanvas(e)}),(0,d.default)((0,c.default)(a),"handleScaleChange",function(e){a.props.dispatch({type:"entry:preview:set:scale",payload:{scale:e}})}),(0,d.default)((0,c.default)(a),"handleOffsetChange",function(e,t){a.props.dispatch({type:"entry:preview:set:canvas:offset",payload:{offset:{x:e,y:t}}})}),a.state={isDraggingCanvas:!1},a}return(0,u.default)(t,e),(0,o.default)(t,[{key:"initDraggingCanvas",value:function(e){var n=this,a=e.clientX,r=e.clientY,t=this.props.canvasOffset,
i=t.x,o=t.y
this.setState({isDraggingCanvas:!0})
function l(e){var t={x:i+(e.clientX-a),y:o+(e.clientY-r)}
n.props.dispatch({type:"entry:preview:set:canvas:offset",payload:{offset:t}})}document.addEventListener("mousemove",l),document.addEventListener("mouseup",function e(t){n.setState({isDraggingCanvas:!1}),document.removeEventListener("mousemove",l),document.removeEventListener("mouseup",e)})}},{key:"render",value:function(){var e=this.props,t=e.scale,n=e.canvasOffset,a=e.project,r=e.screen,i=e.isSpaceDown,o=e.isStickyShow,l=e.isScrollable,s=e.shellType,c=e.isLayerActive,u=e.isCommentActive,
d=e.isColorPickerActive,f=e.isFullScreenMode,p=e.isLayerPreview,h=this.state.isDraggingCanvas,m=n.x,v=n.y,g="landscape"===r.orientation,y=c||u,b=y||!l?"none":s,S=a.width,w=a.height,E=g?[w,S]:[S,w],k=(0,R.default)(E,2),C=k[0],x=k[1],T={width:C,height:x,minWidth:C,minHeight:x,transform:"matrix(1, 0, 0, 1, ".concat(m,", ").concat(v,")")},_={transform:"scale(".concat(t/100,")")},M={width:"".concat(t,"%"),height:"".concat(t,"%")},P={width:r.width*t/100,height:r.height*t/100},I=(0,U.default)({"wait-drag":i||h,
...
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function a(i,o){return c(function(e,t,n){var a=t.dispatch,r=n&&n.payload
a({type:"reducer:projects:update",payload:i(e,r,o)})})}var r=n("WVP6"),i=n("Ehhz").MODEL_OPERATION_MAP.ProjectAlike,o=(0,r.createStateStore)([]),l=o.getState,s=o.setState,c=o.wrapEntry,u={entryMap:{"projects:refresh":a(i.refreshStateList,!1),"projects:add":a(i.addState,!1),"projects:add-local":a(i.addState,!0),"projects:update":a(i.updateState,!1),"projects:update-local":a(i.updateState,!0),"projects:delete":a(i.deleteState,!1),"projects:delete-local":a(i.deleteState,!0)},getState:l,setState:s}
...
t.StyledToggleButton=r},"6PGs":function(e,t,n){e.exports={"screen-info":"_1AJNH2RNIDeT2zJnKkRP2E"}},"6UMJ":function(e,t,n){"use strict"
...
t.commonContentFooter=function(e,t,n,a,r){return[l.default.createElement(b,{key:"footer"},g.parseTimeAgo(1e3*e.updated_at),a&&l.default.createElement(S,{onClick:t?r:a},l.default.createElement(d.default,{type:"dora",name:"reply"}),t?v.preview.comment.cancel_reply:v.preview.comment.comment_create)),t&&l.default.createElement(w,{key:"reply"},l.default.createElement(p.TextEditComponent,{textEditStore:t,placeholder:v.preview.comment.comment_placeholder,minHeight:60,autoHeight:!0,multiline:!0}),(0,
h.getDarkerButton)(v.preview.comment.comment_create,t.endEdit,!n))]}
function y(e){var t=e.sub,n=e.comment,a=e.textEditStore,r=e.cancelEdit
return l.default.createElement(k,{className:t?"sub":""},a?l.default.createElement(x,null,l.default.createElement(p.TextEditComponent,{textEditStore:a,placeholder:v.preview.comment.comment_placeholder,minHeight:60,autoHeight:!0,multiline:!0}),l.default.createElement(T,null,l.default.createElement(c.Button,{onClick:r},v.preview.comment.cancelEdit),l.default.createElement(c.Button,{type:"primary",onClick:a.endEdit},v.preview.comment.updateEdit))):l.default.createElement(C,null,n.message))}
...
function E(e){var t=e.sub,n=e.avatar,a=e.name,r=e.markIndex,i=e.startEdit,o=e.doDelete
...
N.propTypes={onSelect:o.default.func.isRequired,text:o.default.string.isRequired,iconName:o.default.string.isRequired,menuClassName:o.default.string.isRequired}},7:function(e,t,n){n("j36g"),n("55Il"),e.exports=n("Z3xQ")},"7Rdd":function(e,t,n){"use strict"
var a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function r(e){var t=e.refRect,n=e.screen,a=e.style,r=a.dashed,i=a.colorForLines
return o.default.createElement("div",{style:{position:"absolute",pointerEvents:"none",width:(0,l.toPercentage)(t.width/n.width),height:(0,l.toPercentage)(t.height/n.height),left:(0,l.toPercentage)(t.left/n.width),top:(0,l.toPercentage)(t.top/n.height),border:"1px ".concat(r?"dashed":"solid"," ").concat(i)}})}var o=a(n("q1tI")),i=a(n("17x9")),l=n("1qiG")
...
var c=r(n("pVnL")),i=r(n("J4zp")),l=r(n("MVZn")),s=r(n("lwsE")),o=r(n("W8MJ")),u=r(n("a1gu")),d=r(n("Nsbk")),f=r(n("7W2i")),p=r(n("lSNA")),h=a(n("q1tI")),m=r(n("17x9")),v=n("89ER"),g=n("/rSK"),y=n("fiFu"),b="TEMP_MARKER_CID",S=function(e){function t(e){var o;(0,s.default)(this,t),(o=(0,u.default)(this,(0,d.default)(t).call(this,e))).addTempCommentThreadListener=(0,y.muteEvent)(function(e){var t=o.props,n=t.isActive,a=t.permissionPack,r=t.markerDomPack,i=t.dispatch
...
function n(e){var t=0<arguments.length&&void 0!==e?e:null
...
r&&Object.entries(e).forEach(function(e){var t=(0,i.default)(e,2),n=t[0],a=t[1]
return r.removeEventListener(n,a)})},setFocusCommentThreadCid:n,setHoverFocusCommentThreadCid:function(e){var t=0<arguments.length&&void 0!==e?e:null
return!o.props.tempCommentThreadMarker&&n(t)},doUpdateCommentThread:function(e){var t=e.cid,n=e.top,a=e.left
...
var a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function r(){return(new Date).getTime()}var i=a(n("lwsE")),o=a(n("W8MJ")),l=function(){function e(){(0,i.default)(this,e),this.coolDownTime=r(),this.coolDownInterval=200}return(0,o.default)(e,[{key:"isCoolDown",value:function(){var e=r()-this.coolDownTime
...
function g(t){var n={},a={}
return Panel.all().forEach(function(e){e.screen_cid===t&&(e.multi_states?a[e.cid]=C(e):n[e.cid]=k(e))}),Screen.find(t).setState("default",!0),{cid:t,stateCid:"default",panelInfoMap:n,chameleonInfoMap:a}}var d=a(n("QILm")),y=a(n("MVZn")),b=a(n("RIqP")),S=a(n("lSNA")),w=n("upRB"),E=n("RKRO"),k=function(e){var t=e.mainState().cid
...
n({type:"runner:update:state",payload:{transition:{name:"none",delay:0,duration:0,offset:100},screenInfoMap:(0,S.default)({},a,g(a)),history:[]}})},"entry:runner:reload:screen":function(e,t){var n=e.dispatch,a=t.payload.activeCid
n({type:"entry:runner:init:home-screen",payload:{activeCid:a}}),n({type:"entry:runner:activate:screen",payload:{screenCid:a}})},"entry:runner:activate:screen":function(e,t){var n=e.getState,a=e.dispatch,r=t.payload,i=r.screenCid,o=r.transition,l=r.resetTargetScreen,s=void 0===l||l,c=n(),u=(0,w.getRunnerState)(c),d=u.activeCid,f=u.screenInfoMap,p=u.history;/drawer|menu/.test((o=o||{name:"none",delay:0,duration:0,offset:100}).name)?(MB.runner.currentScreen=d,MB.runner.currentMenu=i
...
s&&MB.runner.runnerUtil.resetScreenScrollState(i),a({type:"runner:update:state",payload:{transition:o,screenInfoMap:(0,y.default)({},f,(0,S.default)({},i,v)),activeCid:i,history:h}})},"entry:runner:activate:screen-state":function(e,t){var n=e.getState,a=e.dispatch,r=t.payload,i=r.screenCid,o=r.stateCid,l=r.transition,s=n(),c=(0,w.getRunnerState)(s),u=c.activeCid,d=c.screenInfoMap
...
t.cid=e.cid,t.screen_cid=f.cid,t.multi_states=e.multi_states,t.template_cid=e.template_cid,t.multi_states?g[e.cid]=C(t,l):v[e.cid]=k(t)}),a({type:"entry:runner:update:screen",payload:{screenCid:i,stateCid:o,panelInfoMap:v,chameleonInfoMap:g,transition:m}})}},"entry:runner:back-to-prev-page":function(e,t){var n=e.getState,a=e.dispatch,r=t.payload,i=void 0===r?{}:r,o=n(),l=(0,w.getRunnerState)(o),s=l.history,c=l.transition,u=c.name,d=c.duration,f=c.offset
...
var l=n(),s=(0,w.getRunnerState)(l).screenInfoMap,c=s[i]
if(!c)throw new Error("更新了尚未加载的页面!!")
var u=(0,y.default)({},c,o)
a({type:"runner:update:state",payload:{screenInfoMap:(0,y.default)({},s,(0,S.default)({},i,u))}})},"entry:runner:activate:panel-screen":function(e,t){var n=e.getState,a=e.dispatch,r=t.payload,i=r.panelCid,o=r.panelScreenCid,l=r.transition,s=n(),c=(0,w.getRunnerState)(s).screenInfoMap,u=Panel.find(i).screen_cid,d=c[u],f=d.panelInfoMap[i],p=new Set(f.panelScreens)
p.add(o)
...
a({type:"runner:update:state",payload:{screenInfoMap:(0,y.default)({},c,(0,S.default)({},u,m))}})},"entry:runner:preload:screens":function(e){var t=e.getState,n=e.dispatch,a=t(),r=(0,w.getCurrentProject)(a),i=(0,w.getRunnerState)(a),o=i.activeCid,l=i.screenInfoMap,s=i.history.slice(0,2)
...
var c={}
s.forEach(function(e){c[e]=l[e]||g(e)}),n({type:"runner:update:state",payload:{screenInfoMap:c}})},"entry:runner:update:chameleon":function(e,t){var n=e.getState,a=e.dispatch,r=t.payload,i=r.chameleonCid,o=r.stateCid,l=r.transition,s=n(),c=(0,w.getRunnerState)(s).screenInfoMap,u=Panel.find(i),d=u.screen_cid,f=c[d],p=f.chameleonInfoMap[i],h=(0,y.default)({},p,{stateCid:o,transition:(0,y.default)({},l,{callback:function(){MB.runner.timerHandler.setupPanelTimers(u,o)}})}),m=(0,y.default)({},f,{
chameleonInfoMap:(0,y.default)({},f.chameleonInfoMap,(0,S.default)({},i,h))})
a({type:"runner:update:state",payload:{screenInfoMap:(0,y.default)({},c,(0,S.default)({},d,m))}})}}
...
function S(e){var t=e.tabs,n=e.activeIndex,a=e.onChange,r=e.className,i=e.hideBorder,o=e.BgStyle
...
function o(i){return function(e,t,n){var a=t.cid,r=d.Project.findByAttribute("cid",a)?"Project":d.Template.findByAttribute("cid",a)?"Template":d.Combo.findByAttribute("cid",a)?"Combo":null
return l[r][i](e,t,n)}}var l=i.reduce(function(e,t){function l(e,t){return{dataState:e.find(function(e){return e.cid===t}),dataModel:i.findByAttribute("cid",t)}}var i=d[t],a=p[t],o=f[t]
return e[t]={refreshStateList:function(e){return i.all().map(function(e){return function(t,e){var n=1<arguments.length&&void 0!==e?e:{}
return a.forEach(function(e){return n[e]=t[e]}),n}(e,{})})},saveState:function(e,t,n){var a=t.cid,r=l(e,a),i=r.dataState,o=r.dataModel
return i&&o&&(o.lsave(!n),n||u.default.SpineModel.queueSave()),e},addState:function(e,t,n){var a=t.cid||u.default.SpineModel.requestCid(o)
!function(e,t){var n=e.find(function(e){return e.cid===t}),a=i.findByAttribute("cid",t)
...
return i&&o?(o.ldestroy(!n),n||u.default.SpineModel.queueSave(),(0,c.arrayFindDelete)(e,function(e){return e.cid===a})):e}},e},{});(t.MODEL_OPERATION_MAP=l).ProjectAlike={refreshStateList:function(e){return[].concat((0,r.default)(l.Combo.refreshStateList()),(0,r.default)(l.Project.refreshStateList()),(0,r.default)(l.Template.refreshStateList()),(0,r.default)(l.UserTemplate.refreshStateList()))},saveState:o("saveState"),addState:o("addState"),updateState:o("updateState"),deleteState:o("deleteState")}},
Emwt:function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function a(i,o){return c(function(e,t,n){var a=t.dispatch,r=n&&n.payload
a({type:"reducer:screens:update",payload:i(e,r,o)})})}var r=n("WVP6"),i=n("Ehhz").MODEL_OPERATION_MAP.Screen,o=(0,r.createStateStore)([]),l=o.getState,s=o.setState,c=o.wrapEntry,u={entryMap:{"screens:refresh":a(i.refreshStateList,!1),"screens:add":a(i.addState,!1),"screens:add-local":a(i.addState,!0),"screens:update":a(i.updateState,!1),"screens:update-local":a(i.updateState,!0),"screens:delete":a(i.deleteState,!1),"screens:delete-local":a(i.deleteState,!0)},getState:l,setState:s}
...
function t(e,t){n.setState(e),!t.isEditing&&e.isEditing&&setTimeout(n.focusTextarea,0)}n.bindEditStore=function(e){n.setState(e.getState()),e.subscribe(t)},n.unbindEditStore=function(e){e.unsubscribe(t)},n.onChange=function(e){return n.props.textEditStore.setValue(e)},n.onKeyDown=function(e){"Enter"!==e.key&&13!==e.which||n.props.multiline&&e.shiftKey||(e.preventDefault(),e.stopPropagation(),n.props.textEditStore.endEdit())}
var a=null
...
var i,o,f,h,m,l=n("TqRt")(n("cDf5"))
function a(e,t){for(var n in this.wrapper="string"==typeof e?o.querySelector(e):e,this.scroller=this.wrapper.children[0],this.scrollerStyle=this.scroller.style,this.options={resizeScrollbars:!0,mouseWheelSpeed:20,snapThreshold:.334,disablePointer:!m.hasPointer,disableTouch:m.hasPointer||!m.hasTouch,disableMouse:m.hasPointer||m.hasTouch,startX:0,startY:0,scrollY:!0,directionLockThreshold:5,momentum:!0,bounce:!0,bounceTime:600,bounceEasing:"",preventDefault:!0,preventDefaultException:{
...
this.scrollTo(this.options.startX,this.options.startY),this.enable()}function s(e,t,n){var a=o.createElement("div"),r=o.createElement("div")
...
r.style.width="100%"),a.className="iScrollVerticalScrollbar"),a.style.cssText+=";overflow:hidden",t||(a.style.pointerEvents="none"),a.appendChild(r),a}function c(e,t){for(var n in this.wrapper="string"==typeof t.el?o.querySelector(t.el):t.el,this.wrapperStyle=this.wrapper.style,this.indicator=this.wrapper.children[0],this.indicatorStyle=this.indicator.style,this.scroller=e,this.options={listenX:!0,listenY:!0,interactive:!1,resize:!0,defaultScrollbars:!1,shrink:!1,fade:!1,speedRatioX:0,speedRatioY:0},t
)this.options[n]=t[n]
...
this.indicators=[],this.options.scrollbars&&(this.options.scrollY&&(e={el:s("v",t,this.options.scrollbars),interactive:t,defaultScrollbars:!0,customStyle:n,resize:this.options.resizeScrollbars,shrink:this.options.shrinkScrollbars,fade:this.options.fadeScrollbars,listenX:!1},this.wrapper.appendChild(e.el),a.push(e)),this.options.scrollX&&(e={el:s("h",t,this.options.scrollbars),interactive:t,defaultScrollbars:!0,customStyle:n,resize:this.options.resizeScrollbars,shrink:this.options.shrinkScrollbars,
...
for(var i=a.length;i--;)this.indicators.push(new c(this,a[i]))
...
e=e?"1":"0",this.wrapperStyle[m.style.transitionDuration]=n+"ms",this.fadeTimeout=setTimeout(function(e){this.wrapperStyle.opacity=e,this.visible=+e}.bind(this,e),a)}}},a.utils=m,i.IScroll=a},FYsW:function(e,t,n){"use strict"
var a=n("TqRt")
...
function r(e){return{label:e.label,value:e.family,limitedDevices:e.limitedDevices}}var i=a(n("RIqP")),o=a(n("yl0K")),l=o.default.HOSTED_COMMERCIAL_FANGZHENG_LIST,s=o.default.HOSTED_COMMON_LIST,c=o.default.WESTERN_COMMON_LIST,u=[].concat((0,i.default)(l),(0,i.default)(s),(0,i.default)(c)),d=l.map(r)
...
t.getFontFamilyAndWeightText=function(t,e){var n=l.find(function(e){return e.family===t})
...
a=a.parentNode}return e.ownerDocument||e.documentElement||document.documentElement}t.scrollParent=r
function i(e,t){var n,a,r=p.default.findDOMNode(e)
...
var a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function l(e){var t=e.kind?0:e.rotation,n=(0,y.getMinBoundingRect)((0,r.default)({},e,{rotate:t})),a=(0,h.default)(n,4)
return{top:a[0],left:a[1],width:a[2],height:a[3]}}var o=a(n("pVnL")),s=a(n("lwsE")),i=a(n("W8MJ")),c=a(n("a1gu")),u=a(n("Nsbk")),d=a(n("PJYZ")),f=a(n("7W2i")),p=a(n("lSNA")),r=a(n("MVZn")),h=a(n("J4zp")),m=a(n("17x9")),v=a(n("q1tI")),g=a(n("HNPj")),y=n("/5+U"),b=a(n("dZ9F")),S=function(e){function r(){var e,i;(0,s.default)(this,r)
for(var t=arguments.length,n=new Array(t),a=0;a<t;a++)n[a]=arguments[a]
return i=(0,c.default)(this,(e=(0,u.default)(r)).call.apply(e,[this].concat(n))),(0,p.default)((0,d.default)(i),"renderValue",function(e){var t=i.props,n=t.ratio,a=t.distanceUnit,r=i.getValueRatio()
return v.default.createElement(b.default,(0,o.default)({ratio:n,unit:a,valueRatio:r},e))}),(0,p.default)((0,d.default)(i),"getValueRatio",function(){var e=i.props.selectedLayer,t=e.src_width,n=e.width
return t?t/n:1}),i}return(0,f.default)(r,e),(0,i.default)(r,[{key:"render",value:function(){var e=this.props,t=e.show,n=e.selectedLayer,a=e.hoveringLayer,r=e.screen
if(!t)return null
var i=l(n),o=a?l(a):{top:0,left:0,width:r.width,height:r.height}
...
t.requestSelectLayer=function(e,t){return{type:a,payload:{layerID:e}}}
var r="SELECT_LAYER"
t.SELECT_LAYER=r
...
var a=n("284h"),r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function o(e){return MB.localStorageDelegate.setItem("guide_closed_".concat(e),!0)}var d=r(n("pVnL")),f=r(n("QILm")),l=r(n("lwsE")),s=r(n("W8MJ")),c=r(n("a1gu")),u=r(n("Nsbk")),p=r(n("PJYZ")),h=r(n("7W2i")),m=r(n("lSNA")),i=r(n("17x9")),v=a(n("q1tI")),g=n("6XO9"),y=r(n("rwIS")),b=function(e){function i(){var e,r;(0,l.default)(this,i)
for(var t=arguments.length,n=new Array(t),a=0;a<t;a++)n[a]=arguments[a]
return r=(0,c.default)(this,(e=(0,u.default)(i)).call.apply(e,[this].concat(n))),(0,m.default)((0,p.default)(r),"setGuideRef",function(e){return r.guide=e}),(0,m.default)((0,p.default)(r),"handleCloseGuideManually",function(){o(r.props.id)}),(0,m.default)((0,p.default)(r),"autoClose",function(){var e=r.props,t=e.duration,n=e.autoClose,a=e.id
e.isOpen&&t&&(r.timer=setTimeout(function(){n(),o(a)},t))}),r}return(0,h.default)(i,e),(0,s.default)(i,[{key:"componentDidUpdate",value:function(e){e.isOpen!==this.props.isOpen&&this.autoClose()}},{key:"componentWillUnmout",value:function(){clearTimeout(this.timer)}},{key:"render",value:function(){var e=this.props,t=e.id,n=e.isOpen,a=e.children,r=e.localeKey,i=e.position,o=e.className,l=(0,f.default)(e,["id","isOpen","children","localeKey","position","className"])
...
function x(e,t){e.top,e.left
var n=e.width,a=e.height,r=e.bs,i=e.points,o=1<arguments.length&&void 0!==t&&t,l=Math.sqrt(n*n+a*a),s=r,c=JSON.parse(i).map(function(e){return e.point}),u=d(n,a,c)
return{length:o?Math.round(l):l,angle:o?Math.round(u)%360:u,thickness:s}}var P=a(n("J4zp"))
t.getLineGeneralInfo=x
var d=function(e,t,n){var a=(0,P.default)(n,2),r=a[0],i=a[1],o=(i[0]-r[0])*e,l=(i[1]-r[1])*t
return s(o,l)}
t.getLineAngle=d
...
t.degreeToRadians=T
function I(e,t){var n=(0,P.default)(e,2),a=n[0],r=n[1],i=T(t)
return[Math.cos(i)*a+Math.sin(i)*r,-Math.sin(i)*a+Math.cos(i)*r]}t.getVectorInOtherSystem=I
...
t.getLineAttrsAfterRotate=function(e,t,n){var a=2<arguments.length&&void 0!==n?n:0,r=T(t),i=e.top,o=e.left,l=e.width,s=e.height,c=e.points,u=JSON.parse(c).map(function(e){return e.point}),d=(0,P.default)(u,2),f=(0,P.default)(d[0],2),p=f[0],h=f[1],m=(0,P.default)(d[1],2),v=m[0],g=m[1],y=x(e).length,b=[o+l*p,i+s*h],S=[o+l*v,i+s*g],w=[b[0]+(S[0]-b[0])*a,b[1]+(S[1]-b[1])*a],E=[b[0]+y*Math.cos(r),b[1]+y*Math.sin(r)],k=[b[0]+(E[0]-b[0])*a,b[1]+(E[1]-b[1])*a],C=[w[0]-k[0],w[1]-k[1]]
...
var D=a(n("lSNA")),i=n("XrEr"),O=n("qOCw")
...
return f.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:2<l.length&&void 0!==l[2]?l[2]:5e3,a=3<l.length&&void 0!==l[3]?l[3]:1/0,r=n=1<l.length&&void 0!==l[1]?l[1]:250,i=0
...
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function a(i,o){return c(function(e,t,n){var a=t.dispatch,r=n&&n.payload
a({type:"reducer:comments:update",payload:i(e,r,o)})})}var r=n("WVP6"),i=n("Ehhz").MODEL_OPERATION_MAP.Comment,o=(0,r.createStateStore)([]),l=o.getState,s=o.setState,c=o.wrapEntry,u={entryMap:{"comments:refresh":a(i.refreshStateList,!1),"comments:add":a(i.addState,!1),"comments:add-local":a(i.addState,!0),"comments:update":a(i.updateState,!1),"comments:update-local":a(i.updateState,!0),"comments:delete":a(i.deleteState,!1),"comments:delete-local":a(i.deleteState,!0)},getState:l,setState:s}
...
t.processSaveQueue=function(e){var a={},r=[];(0<arguments.length&&void 0!==e?e:[]).forEach(function(e){var t=e.record,n="".concat(t.constructor.className,"-").concat(t.cid)
...
if("Panel"===a)Template.find(t.template_cid)
...
function r(e,t,n){return void 0===t&&(t=null),void 0===n&&(n=null),{value:e,prev:t,next:n}}t.createNode=r,t.createDoublyLinkedList=function(){function e(){i=new Set,o=r(null),l=r(null),(o.next=l).prev=o}var i,o,l
e()
function t(e,t){var n=t.next
t.next=n.prev=e,e.prev=t,e.next=n,i.add(e)}function n(e,t){var n=t.prev
t.prev=n.next=e,e.prev=n,e.next=t,i.add(e)}function a(e){var t=e.prev,n=e.next;(t.next=n).prev=t,e.prev=e.next=null,i.delete(e)}return{clear:e,getHead:function(){return o},getTail:function(){return l},getLength:function(){return i.size},insertAfter:t,insertBefore:n,remove:a,removeBetween:function(e,t){var n=e.prev,a=t.next;(n.next=a).prev=n,e.prev=t.next=null
...
function n(e){var t=e.clientY,n=e.clientX,a="x"===r?n-i:t-o
a=a/(p-p/d[r]*p)*d[r],f("x"===r?{x:l-a,y:s}:{x:l,y:s-a})}var r=e.target.dataset.axis,i=e.clientX,o=e.clientY,t=y.props,a=t.canvasOffset,l=a.x,s=a.y,c=t.viewportHeight,u=t.viewportWidth,d=t.canvasRange,f=t.onScroll,p="x"===r?u:c
document.addEventListener("mousemove",n),document.addEventListener("mouseup",function e(t){document.removeEventListener("mousemove",n),document.removeEventListener("mouseup",e)})}),(0,d.default)((0,c.default)(y),"handleClickTrack",function(e){function t(){var e=v.getBoundingClientRect(),t=e.top,n=e.bottom,a=e.left,r=e.right,i=y.props.canvasOffset,o=i.x,l=i.y,s="x"===d?r<f:n<p,c="x"===d?f<a:p<t,u=(c?-1:s?1:0)*Math.min(m[d]/10,g);(s||c)&&h("x"===d?{x:o-u,y:l}:{x:o,y:l-u})}var d=e.target.dataset.axis,
f=e.clientX,p=e.clientY,n=y.props,h=n.onScroll,m=n.canvasRange,a=n.viewportHeight,r=n.viewportWidth,i=y.scrollbarX.getBoundingClientRect(),o=i.top,l=i.bottom,s=i.left,c=i.right,v="x"===d?y.scrollbarX:y.scrollbarY,g="x"===d?r:a;(("x"===d?c<f:l<p)||("x"===d?f<s:p<o))&&(v.style.transition="all 0.1s linear",t(),y.timer=setTimeout(function(){return y.timeInterval=setInterval(t,100)},500))
...
var a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function r(e){var t=e.value,n=e.ratio,a=e.valueRatio,r=e.unit,i=e.style,o=e.className,l=e.customClassName,s=(0,u.adapterScreen)(t,n)
return c.default.createElement("div",{style:i,className:"".concat(o," ").concat(l)},"".concat(Math.round(s*a)).concat(r))}var c=a(n("q1tI")),i=a(n("17x9")),o=a(n("vOnD")),u=n("/5+U"),l=(0,o.default)(r).withConfig({displayName:"MarkLabel__StyledMarkValue",componentId:"sc-1b6nimd-0"})(["padding:0 5px;color:#fff;background-color:#ff7100;border-radius:2px;"])
...
switch(t.type){case i.RECEIVE_RESOURCE_SUCCESS:case i.RECEIVE_RESOURCE_ERROR:return Object.assign({},e,(0,r.default)({},t.payload.screenID,function(e,t){var n=0<arguments.length&&void 0!==e?e:{isFetching:!1,layers:[],error:""},a=1<arguments.length?t:void 0
switch(a.type){case i.RECEIVE_RESOURCE_SUCCESS:return Object.assign({},n,{isFetching:!1,layers:a.payload.layers,error:void 0,artboard:a.payload.artboard,documentColor:a.payload.document_colors,globalColor:a.payload.global_colors,globalText:a.payload.text_styles})
case i.RECEIVE_RESOURCE_ERROR:return Object.assign({},n,{isFetching:!1,layers:[],error:a.payload.error})
default:return n}}(e[t.payload],t)))
...
var a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var i=a(n("lwsE")),o=a(n("W8MJ")),r=function(){function e(){(0,i.default)(this,e),this.timeoutMap=new Map}function t(e,t){return n.apply(this,arguments)}var n,a
function r(e,t,n){return a.apply(this,arguments)}return(0,o.default)(e,[{key:"setTimeout",value:(a=function(e,t,n){var a=this,r=setTimeout(function(){t(),a.clearTimeout(e,t)},n)
return this.setToken(e,t,r),r},r.toString=function(){return a.toString()},r)},{key:"clearTimeout",value:(n=function(e,t){var n=this.getToken(e,t)
void 0!==n&&(clearTimeout(n),this.clearToken(e,t))},t.toString=function(){return n.toString()},t)},{key:"clearTimeoutByKey",value:function(n){var a=this,e=this.timeoutMap.get(n)
...
n&&n.delete(t)}}]),e}()
t.default=r},fSKh:function(e,t,n){},fcSx:function(e,t,n){"use strict"
var a=n("TqRt")
...
function a(e){e&&e.preventDefault(),e&&e.stopPropagation()}t.MUTE_EVENT=a
...
t.getCommentPermission=function(e,t,n,a){var r=e&&(3<arguments.length&&void 0!==a?a:"INVALID_ID_1")===(2<arguments.length&&void 0!==n?n:"INVALID_ID_0")
...
t.getUserAuthStatus=function(t,e){var n=1<arguments.length&&void 0!==e?e:[]
return(t=t&&String(t))?n.some(function(e){return e.user_id===t})?"MEMBER":o:r}},flWF:function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function a(i,o){return c(function(e,t,n){var a=t.dispatch,r=n&&n.payload
a({type:"reducer:widgets:update",payload:i(e,r,o)})})}var r=n("WVP6"),i=n("Ehhz").MODEL_OPERATION_MAP.Widget,o=(0,r.createStateStore)([]),l=o.getState,s=o.setState,c=o.wrapEntry,u={entryMap:{"widgets:refresh":a(i.refreshStateList,!1),"widgets:add":a(i.addState,!1),"widgets:add-local":a(i.addState,!0),"widgets:update":a(i.updateState,!1),"widgets:update-local":a(i.updateState,!0),"widgets:delete":a(i.deleteState,!1),"widgets:delete-local":a(i.deleteState,!0)},getState:l,setState:s}
...
function R(){return m.default.createElement("div",{className:_("layer-load")},m.default.createElement("span",{className:_("spinner")}))}var L=function(){return m.default.createElement("div",{className:_("download-slice-load")},m.default.createElement(R,null))},j=function(){return m.default.createElement("div",{className:_("slice-load-wrap")},m.default.createElement(R,null))},A=function(){return m.default.createElement("div",{className:_("no-slice")},m.default.createElement("img",{
...
Array.isArray(a)?i[n]=a[r]:"object"===(0,l.default)(a)?i[n]=o(a,r):i[n]=a}),i}var l=a(n("cDf5")),s=a(n("J4zp")),r=["#FF6161","#FF6161"],i=["#FFF","#F2F2F2","#000"],c=["#DEDEE4","#D9D9D9"],u=["#F2F2F2","#fff"],d=["#E8E8E8","#DBDBDB"],f={radioLine:{border:["2px solid #F2F2F2","1px solid #C8CDD0"],bg:["#F2F2F2","#F2F2F2"],border_color:["#F2F2F2","#C8CDD0"],active_bg:["#FFFFFF","#FCFCFC"]},shortCutBoder:{border:["1px solid #c8cdd0","1px solid transparent"]},fixedSlider:{bg:["#d9d9d9","#dbdbdb"]},slider:{bg:[
"#e7e9ea","#C8CDD0"]},linkback:{color:["#101010","#5B6B73"],border:["1px solid transparent","1px solid #d9d9d9"]},palette:{active_color:r,high_light_color:["#298DF8","#298DF8"],hr_color:c,panel_bg:i},toolbar:{height:56,shadow:["1px 0 6px 0 rgba(39, 54, 78, 0.12)","0 0 10px 0 rgba(0, 0, 0, 0.25)"],bg:["#FFF","#EDEDED","#000"],icon_disable_color:["#C8CDD0","#C8CDD0"],project_title_color:["#5B6B73","#5B6B73"],icon_color:["#7d8694","#5B6B73"],hover_icon_color:["#415058","#1F292E"],active_icon_color:["#FF6161",
"#FF6161"],active_icon_bg:["#F2F2F2","#E8E8E8"],active_icon_border:["#E8E8E8","#DBDBDB"]},popups:{bg:i,bc:["#DBDBDB","#DEDEE4","#FFF"],header:{bg:["#F2F3F4","#DBDBDB"],tc:["#415058","#415058","#FFF"],icon_color:["#8D9EA7","#8D9EA7"],line_color:["#EDEDED","#E8E8E8"]},line:{label_color:["#1F292E","#1F292E","#1F292E"]},nav:{bg:i,border_color:c,active_border_color:r,label_color:["#415058","#415058"],label_active_color:["#525E71","#525E71"]},footer:{background:["#fff","#fff"],icon_active_color:r}},panel:{bg:i,
export_bar:{bg:["#F5F5F5","#EDEDED"],laber_color_bg:["#fff","#f2f2f2"],disabled_bg:["#fff","#f7f7f7"],disabled_border_color:["#f7f7f7","#f2f2f2"]},header:{bg:["#F2F3F4","#DBDBDB"]},nav:{active_bg:i,icon_color:["#5B6B73","#5B6B73"],icon_active_color:r}},draggablePanel:{bg:i,header:{bg:["#F2F3F4","#DBDBDB"]},layerItem:{bg:["#DBDBDB","#F2F2F2"]},input:{bg:u,border_color:d,border:["1px solid transparent","1px solid #DBDBDB"]},BorderRadius:{border_color:["#f2f2f3","#c8cdd1"]},CheckBorder:{border_color:["#8d9ea6"
,"#bacdd6"]},NumberInput:{bg:u,border_color:d,disabled_bg:["#F7F7F7","#fff"],disabled_border_color:["#F2F2F2","#e8e8e8"]},Select:{bg:u,border_color:d}},viewMode:{bg:["#E1E1E1","#E8E8E8"]},leftpane:{shadow:["0 2px 30px 0 rgba(213, 213, 213, 0.5)"],border_right:["","1px solid #C8CDD0"]},rightpane:{shadow:["0 -2px 30px 0 rgba(39,54,78,0.11)"]},subpanel:{border_top_color:["#dbdbdb","#D9D9D9"]},textarea:{bg:u,border_color:d},sidebar:{bg:i,divider_color:["#C8CDD0","#C8CDD0"],icon_color:["#5B6B73","#5B6B73"],
icon_hover_color:["#415058","#415058"],icon_active_color:r,icon_active_bg:["#F4F5F6","#F4F5F6"],icon_hover_bgcolor:["#f2f2f2","#E8E8E8"],icon_hover_border_color:["#E8E8E8","#DBDBDB"],border_right:["1px solid #DEDEE4","1px solid #C8CDD0"],border_left:["","1px solid #C8CDD0"]},leftnav:{bg:i,nav_icon_hover:["#FCFCFC","#EBEBEB"]},basicWidgets:{bg:i,border_color:["#DEDEE4","#c8cdd0"],icon_color:["#6C6D6E","#6C6D6E"],icon_hover_color:["#f2f2f2","#E8E8E8"],icon_hover_border_color:["#E8E8E8","#DBDBDB"]},ruler:{
bgColor:["transparent","transparent"],longfgColor:["#BABBBC","#BABBBC"],shortfgColor:["#C8CDD0","#C8CDD0"],fontColor:["#8D9EA7","#8D9EA7"],shadowColor:["#E8E8E8","#E8E8E8"],lineColor:["#EB5648","#EB5648"],borderColor:["#DADADC","#DEDEE4"],cornerActiveColor:["rgb(235, 86, 72, 0.6)","rgb(235, 86, 72, 0.6)"]},screenContainer:{bg:["#F5F5F5","#f9f9f9","#000"]},scrollbar:{track:{bg:["transparent","transparent"]},thumb:{x_bg:["#D2D2D8","#BCBCBC"],y_bg:["#DEDEE4","#BCBCBC"],x_hover_bg:["#BEC3C5"],y_hover_bg:[
"#C8CDD0"]}},listItem:{tc:["#5B6B73","#415058"],hover:{tc:["#298DF8","#298DF8"],bc:["#E8E8E8","#D9D9D9"],bg:["#F7F7F7","#E8E8E8"]},expander_color:["#C8CDD0","#8D9EA7"],action_color:["#8D9EA7","#8D9EA7"],action_hover_color:["#5B6B73","#1F292E"],active:{bg:["#F2F2F2","#FFF"],tc:["#298DF8","#298DF8"],bc:["#EBEBEB","#EBEBEB"]}},thumbnail:{bg:["#F2F2F2","#EBEBEB"],border_color:["#EDEDED","#DBDBDB"]},preferenceBar:{bg:["#F5F5F5","#F9F9F9"],bc:["#E7E9EA","#DBDBDB"]},colorButton:{bg:["#F6F7F8","#FCFCFC"],
border_color:["#F2F2F3","#DBDBDB"]},searchBar:{bg:u,border_color:d},interation:{hover:{border_color:["#1E98EA","#1E98EA"]},active:{border_color:["#1E98EA","#1E98EA"],box_shadow:["0 0 4px 0 rgba(34, 162, 237, 0.66)","0 0 4px 0 rgba(34, 162, 237, 0.66)"]}},noComponentImage:["url('/images/workspace/design/no_component_list_light.png')","url('/images/workspace/design/no_component_list_grey.png')"],carouselSettings:{assetBoxBg:["#f7f7f7","#ebebeb"],addAssetIconFill:["#c8cdd0","#8d9ea7"]},linkSettings:{linkView:{
detail_bg:["#f7f7f7","#fff"]},gesture:{bg:["#EBEBEB","#FFF"],border_color:["#EBEBEB","#FFF"],hover:{border_color:["#298DF8","#298DF8"]},active:{border_color:["#298DF8","#298DF8"]}},linkPanel:{bg:["#f7f7f7","#FFF"],divider:["#FFF","#f7f7f7"]}}},p={light:o(f,0),grey:o(f,1),dark:o(f,2)}
...
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function a(i,o){return c(function(e,t,n){var a=t.dispatch,r=n&&n.payload
a({type:"reducer:collaborators:update",payload:i(e,r,o)})})}var r=n("WVP6"),i=n("Ehhz").MODEL_OPERATION_MAP.Collaborator,o=(0,r.createStateStore)([]),l=o.getState,s=o.setState,c=o.wrapEntry,u={entryMap:{"collaborators:refresh":c(function(e,t,n){var a=t.dispatch,r=n&&n.payload;(e=i.refreshStateList(e,r,!1)).forEach(function(e){e.avatar||(e.avatar="/images/avatar.png")}),a({type:"reducer:collaborators:update",payload:e})}),"collaborators:add":a(i.addState,!1),"collaborators:add-local":a(i.addState,!0),
"collaborators:update":a(i.updateState,!1),"collaborators:update-local":a(i.updateState,!0),"collaborators:delete":a(i.deleteState,!1),"collaborators:delete-local":a(i.deleteState,!0)},getState:l,setState:s}
...
var a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function r(e){var t=e.layer,n=e.unit,a=e.ratio,r=e.showGlobal,i=e.userPickColor,o=void 0===i?[]:i,l=e.globalColor,s=void 0===l?[]:l,c=e.globalText,u=void 0===c?[]:c,d=e.documentColor,f=void 0===d?[]:d,p=e.screenColor,h=void 0===p?[]:p,m=e.language,v=e.colorUnit,g=e.dispatch,y=t.src_left,b=t.src_top,S=t.src_width,w=t.src_height,E=t.origin_width,k=t.origin_height,C=t.bd_radius,x=t.line_height,T=t.bg_colors,_=void 0===T?[]:T,M=t.borders,P=void 0===M?[]:M,I=t.i,N=t.display_name,R=t.padding,L=void 0===R?0:R,
j=t.hiddSpacing,A=void 0!==j&&j,B=t.text_styles,D=void 0===B?[]:B,O=t.alignment,F=t.vertical_alignment,q=t.image,W=t.text,U=t.letter_spacing,z=t.image_set_zip,Y=t.shadows,H=void 0===Y?[]:Y,V=t.inner_shadows,X=void 0===V?[]:V,J=t.rotation,Z=t.textShadows,K=void 0===Z?[]:Z,G=t.image_set,Q=void 0===G?[]:G,$=t.name,ee=0<P.length,te=0<_.length,ne=!!q,ae=0<D.length&&W&&(0,je.getTextContent)(t).length,re=0<H.length||0<K.length,ie=0<X.length,oe=z,le={left:y,top:b,width:E||S,height:k||w,borderRadius:C,opacity:t.o,
rotation:J,ratio:a,unit:n}
...
function y(e){return e?e.replace(S,"").trim():o.default}var m=a(n("MVZn")),u=n("G3NE"),o=a(n("cl8F")),l=n("Ibie"),d=n("FkXu"),b=n("LbTH"),i=n("2EV6"),s=n("/5+U"),c=n("upRB"),S=/\\\w+/gi
t.checkColor=y
...
if(m&&(n=w(m.replace(/<p>/g,"").replace(/<\/p>/g,"\n")),a.text_styles=(0,b.checkIfItemTextIsNewVersion)(e)?[k(JSON.parse(e.text))]:[{font_size:e.fs,color:y(e.tc||E(r,"tc",t)),length:n.length,font_face:C(m,t)}],a.text=n),s&&(a.alignment=s),c&&(a.vertical_alignment=c),u&&(a.line_height=u),o&&(a.bd_radius=o),i&&(a.rotation=i),a.bc=y(e.bc||E(r,"bc",t)),l&&(a.borders=[{thickness:l,color:y(a.bc)}]),e.bg&&(a.bg_colors=[{value:y(e.bg)}]),"triangleb"!==r&&"triangletl"!==r&&"icon_button"!==r&&"svg_icon_button"!==r||(
a.bg_colors=[{value:y(e.tc||E(r,"tc"))}]),d){var v=JSON.parse(d)[0]
a.shadows=[{offset_x:v[1],offset_y:v[2],blur_radius:v[3],spread:v[4],color:y(v[5].replace(S,""))}]}else p&&h&&(a.shadows=[{color:y(p.replace(S,"")),blur_radius:h}])
if(f){var g=JSON.parse(f)[0]
a.textShadows=[{offset_x:g[0],offset_y:g[1],blur_radius:g[2],color:y(g[3].replace(S,""))}]}else e.ts&&(a.textShadows=[{color:y(e.tsc.replace(S,"")),blur_radius:e.ts}])
...
var u=a(n("lSNA")),r=a(n("MVZn")),i=n("WVP6"),c=a(n("iScx")),d=a(n("TZdj")),f=a(n("uW4e")),p=a(n("4YeV")),h=a(n("Emwt")),l=a(n("ni9f")),o=a(n("flWF")),m=a(n("HFhh")),v=a(n("JXIg")),g=a(n("zkrS")),y=n("oose"),b=n("tQ2B"),s=(0,r.default)({},c.default.entryMap,d.default.entryMap,f.default.entryMap,p.default.entryMap,h.default.entryMap,l.default.entryMap,o.default.entryMap,m.default.entryMap,v.default.entryMap,{"entry:add-mock-collaborator":function(e){function t(e,t){var n="co_MOCK_".concat(e.cid)
o.has(n)||a({type:"collaborators:add-local",payload:{cid:n,role:"owner",user_id:e.owner_id,name:e.owner_name,email:e.owner_email||"email_MOCK_".concat(e.owner_id),avatar:e.owner_avatar,team_cid:t?e.cid:null,project_cid:t?null:e.cid}})}var a=e.dispatch,n=l.default.getState(),r=p.default.getState(),i=c.default.getState(),o=new Set(i.map(function(e){return e.cid}))
n.forEach(function(e){return t(e,!0)}),r.forEach(function(e){return t(e,!1)})},"entry:current:set":function(e,t){var n=e.dispatch,a=t.payload,r=a.project,i=a.screen,o=v.default.getState(),l=r&&r.cid||o.projectCid,s=i&&i.cid||o.screenCid
...
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function a(i,o){return c(function(e,t,n){var a=t.dispatch,r=n&&n.payload
a({type:"reducer:teams:update",payload:i(e,r,o)})})}var r=n("WVP6"),i=n("Ehhz").MODEL_OPERATION_MAP.Team,o=(0,r.createStateStore)([]),l=o.getState,s=o.setState,c=o.wrapEntry,u={entryMap:{"teams:refresh":a(i.refreshStateList,!1),"teams:add":a(i.addState,!1),"teams:add-local":a(i.addState,!0),"teams:update":a(i.updateState,!1),"teams:update-local":a(i.updateState,!0),"teams:delete":a(i.deleteState,!1),"teams:delete-local":a(i.deleteState,!0)},getState:l,setState:s}
t.default=u},"o/90":function(e,t,n){"use strict"
var a=n("284h"),r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function i(e){var t=document.querySelector(".full-screen header"),n=document.querySelector(".full-screen #mb-preview-leftpane"),a=document.querySelector(".full-screen #mb-preview-rightpane"),r=document.querySelector("#preview_scrollBar_viewport"),i=Array.from(r.querySelectorAll(".track, .handler")),o=document.querySelector("#simulator-container"),l=[t,n,a].concat((0,p.default)(i)).filter(function(e){return e})
"hide"===e?(o.style.overflow="visible",l.forEach(function(e){return e.style.opacity=0}),setTimeout(function(){return l.forEach(function(e){return e.style.pointerEvents="none"})},300)):"show"===e&&(o.style.overflow="hidden ",l.forEach(function(e){return e.style.pointerEvents="auto"}),setTimeout(function(){return l.forEach(function(e){return e.style.opacity=1})},300))}var o=r(n("lwsE")),l=r(n("W8MJ")),s=r(n("a1gu")),c=r(n("Nsbk")),u=r(n("PJYZ")),d=r(n("7W2i")),f=r(n("lSNA")),p=r(n("RIqP")),h=r(n("17x9")),m=a(
n("q1tI")),v=r(n("DKAG")),g=r(n("p2ZH")),y=r(n("2b0G")),b=r(n("4QcC")),S=r(n("ER7e")),w=r(n("Kurm")),E=r(n("TSYQ")),k=function(e){function t(e){var l
return(0,o.default)(this,t),l=(0,s.default)(this,(0,c.default)(t).call(this,e)),(0,f.default)((0,u.default)(l),"setMode",function(e){var t=l.state.isDarkMode,n=e.target.dataset.mode
"light"===n&&t&&l.setState({isDarkMode:!1}),"dark"!==n||t||(MB.event("preview","工具栏: 全屏模式暗色背景"),l.setState({isDarkMode:!0}))}),(0,f.default)((0,u.default)(l),"handleKeyDown",function(e){37===e.keyCode&&l.goToScreenByStep(-1),39===e.keyCode&&l.goToScreenByStep(1)}),(0,f.default)((0,u.default)(l),"handleNavigate",function(e){var t=e.currentTarget.dataset.action
"last"===t?(MB.event("*","运行页-预览-全屏模式-点击上一页"),l.goToScreenByStep(-1)):"next"===t&&(MB.event("*","运行页-预览-全屏模式-点击下一页"),l.goToScreenByStep(1))}),(0,f.default)((0,u.default)(l),"handleExitFullScreen",function(){l.props.dispatch({type:"entry:exit:fill-screen-mode"})}),(0,f.default)((0,u.default)(l),"goToScreenByStep",function(e){var t=l.props,n=t.screen,a=t.screenInOrder,r=t.dispatch,i=n.cid,o=a.findIndex(function(e){return e===i})+e
...
t.default=k,(0,f.default)(k,"propTypes",{dispatch:h.default.func,screen:h.default.object,screenInOrder:h.default.array,scale:h.default.number})},oKLx:function(e,t,n){},oQ6s:function(e,t,n){},oSKl:function(e,t,n){},oose:function(e,t,n){"use strict"
var a=n("TqRt")
...
function f(){}var p=a(n("o0o1")),h=a(n("yXPU")),m=n("ZiVu")
t.createSaveQueue=function(e){function r(e){u=e}var t=e.onError,i=e.doSave,n=e.beforeSave,o=void 0===n?f:n,a=e.afterSave,l=void 0===a?f:a,s=[],c=!1,u={},d=function(){var e=(0,h.default)(p.default.mark(function e(){var t,n,a
return p.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return o(),t=s,s=[],c=!0,e.next=6,(0,m.catchAsync)(i,t,r)
case 6:if(n=e.sent,a=n.error,c=!1,u={},a&&console.error("[Error][saveAsync] savingDataQueue: ".concat(t.length,", dataQueue: ").concat(s.length),a),a)throw a
e.next=13
break
case 13:l()
...
var r=function(){var t=(0,h.default)(p.default.mark(function e(t){var n,a,r,i,o,l
return p.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:n=t.task,a=t.onError,r=t.timeout,i=t.retry,o=void 0===i?8:i,l=0
...
var a=n("284h"),r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function o(t,n){return new Promise(function(e){t.src=n,t.onload=function(){return e(t)},t.onerror=function(){return e()}})}var l=r(n("pVnL")),s=r(n("QILm")),c=r(n("o0o1")),u=r(n("yXPU")),d=r(n("lwsE")),f=r(n("W8MJ")),p=r(n("a1gu")),h=r(n("Nsbk")),m=r(n("PJYZ")),v=r(n("7W2i")),g=r(n("lSNA")),y=a(n("q1tI")),i=r(n("17x9")),b=n("QQiC"),S=n("/5+U"),w=(0,b.createAsyncTaskQueue)().pushTask,E=function(e){function i(){var e,t;(0,d.default)(this,i)
for(var n=arguments.length,a=new Array(n),r=0;r<n;r++)a[r]=arguments[r]
return t=(0,p.default)(this,(e=(0,h.default)(i)).call.apply(e,[this].concat(a))),(0,g.default)((0,m.default)(t),"getElementRef",function(e){return t.imageRef=e}),t}return(0,v.default)(i,e),(0,f.default)(i,[{key:"componentDidMount",value:function(){var i=this
w((0,u.default)(c.default.mark(function e(){var t,n,a,r
return c.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return t=i.props,n=t.src,a=t.adjustImage,e.next=3,o(i.imageRef,n)
case 3:r=e.sent,a&&r&&(0,S.adjustImageRect)({image:r,adjust:a})
...
return y.default.createElement("img",(0,l.default)({alt:"",ref:this.getElementRef},t))}}]),i}(y.PureComponent);(t.default=E).propTypes={src:i.default.string,adjustImage:i.default.number}},q3nj:function(e,t,n){"use strict"
var a=n("TqRt")
...
for(var a in n)Object.prototype.hasOwnProperty.call(n,a)&&(e[a]=n[a])}return e}).apply(this,arguments)}function b(e,t,n,a){return r({},(0,y.createNode)(t),{key:e,size:n,expireAt:a})}t.createCache=b,t.createCacheMap=function(e){function l(e){h.set(e.key,e),m.unshift(e),v+=e.size,r&&p({type:"add",key:e.key,payload:e.value})}function s(e){h.delete(e.key),m.remove(e),v-=e.size,r&&p({type:"delete",key:e.key,payload:e.value})}var i=e.valueSizeSumMax,t=e.valueSizeSingleMax,o=void 0===t?Math.max(.05*i,1):t,
n=e.eventHub,a=void 0===n?(0,g.createHub)():n,r=Boolean(a),c=r?a:{},u=c.clear,d=c.subscribe,f=c.unsubscribe,p=c.send,h=new Map,m=(0,y.createDoublyLinkedList)(),v=0
return{hasEventHub:r,clearHub:u,subscribe:d,unsubscribe:f,clear:function(){return h.forEach(s)},getSize:function(){return h.size},getValueSize:function(){return v},set:function(e,t,n,a){void 0===n&&(n=1),void 0===a&&(a=Date.now()+6e4)
var r=h.get(e)
if(r&&s(r),!(o<n)){for(;i<n+v;)s(m.getTail().prev)
l(b(e,t,n,a))}},get:function(e,t){void 0===t&&(t=Date.now())
var n=h.get(e)
if(n)return n.expireAt<=t?s(n):(m.setFirst(n),n.value)},touch:function(e,t){void 0===t&&(t=Date.now()+6e4)
var n=h.get(e)
if(n)return n.expireAt=t,m.setFirst(n),n.value},delete:function(e){var t=h.get(e)
return t&&s(t),t&&t.value},packList:function(){var i=[]
return m.forEachReverse(function(e){var t=e.key,n=e.value,a=e.size,r=e.expireAt
...
i.expireAt<=o?s(i):l(i)})}}}},rESR:function(e,t,n){"use strict"
var a=n("284h"),r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function a(i,o){return c(function(e,t,n){var a=t.dispatch,r=n&&n.payload
a({type:"reducer:comment-threads:update",payload:i(e,r,o)})})}var r=n("WVP6"),i=n("Ehhz").MODEL_OPERATION_MAP.CommentThread,o=(0,r.createStateStore)([]),l=o.getState,s=o.setState,c=o.wrapEntry,u={entryMap:{"comment-threads:refresh":a(i.refreshStateList,!1),"comment-threads:save":a(i.saveState,!1),"comment-threads:add":a(i.addState,!1),"comment-threads:add-local":a(i.addState,!0),"comment-threads:update":a(i.updateState,!1),"comment-threads:update-local":a(i.updateState,!0),"comment-threads:delete":a(
i.deleteState,!1),"comment-threads:delete-local":a(i.deleteState,!0)},getState:l,setState:s}
...
this.timerFired=!1,this.panelTimerMap={},this.timeoutBucket.clear()}},{key:"setupPageTimers",value:function(e,t){var n=this,a=1<arguments.length&&void 0!==t?t:"default"
...
n&&r.push(n)}}),r.forEach(function(e){0<parseFloat(e.timer)&&(!e.targetstate_cid||e.sourcestate_cid===a)&&n.pageTimer(e)}),e.cpanels().forEach(function(e){n.setupPanelTimers(e,e.mainState().cid)})}}},{key:"setupPanelTimers",value:function(t,a){var n=this
...
r.cancelFrameUpdate=a,r.requestFrameUpdate=n,r.createTimer=function(e){function t(){u&&(u=l(t,i),r())}function n(){u||(u=l(t,i))}function a(){u&&(c(u),u=null)}var r=e.func,i=e.delay,o=e.queueTask,l=void 0===o?setTimeout:o,s=e.cancelTask,c=void 0===s?clearTimeout:s,u=null
return{start:n,stop:a,isActive:function(){return Boolean(u)},getDelay:function(){return i},setDelay:function(e){e!==i&&(i=e,a(),n())}}}}).call(this,t("yLpj"))},xn7q:function(e,t,n){e.exports={previewPanelLayer:"McoEqJKUUcz4r7-DS9tH",layerInfo:"CjM2RPzWdeKb7pXpcipsf"}},"xo+i":function(e,t,n){"use strict"
var a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
function r(e){var n=0<arguments.length&&void 0!==e?e:{}
return new Promise(function(e,t){(0,s.alertAsyncBlocked)(n).then(e),setTimeout(t,6e4)}).catch(function(){return setTimeout(function(){return(0,c.POST_REPORT)({type:"Error:alertAsyncBlocked:timeout",option:n})},0)})}var i=a(n("o0o1")),o=a(n("yXPU")),l=n("xV1f"),s=n("XkTy"),c=n("Clcl"),u=window,d=u.$,f=u.MB,p=function(){var t=(0,o.default)(i.default.mark(function e(t){var n,a=arguments
return i.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=1<a.length&&void 0!==a[1]?a[1]:-255,e.next=3,r({desc:I18N.unknown_error.replace(/%s/i,n),isHTML:!0})
...
var i=r.layers
return e?(0,m.default)(i,function(e){return e.id===a}):(0,v.default)({},i[0])})},zy85:function(e,t,n){e.exports={"runner-control-panel":"_1X_2UmrkGlhWCjY4oDmJxO"}}},[[7,1,0]]])

//# sourceMappingURL=preview-97f5d70839bbb89783d8.js.map